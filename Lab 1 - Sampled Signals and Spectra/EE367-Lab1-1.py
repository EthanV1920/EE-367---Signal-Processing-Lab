"""
File: EE367-Lab1-1.py
Author: Ethan Vosburg
Date: 01-25-24
Description: This file contains the code for part 1 of Lab 1 for EE367. This 
file creates a 2 second long 2000 Hz cosine wave with a 45 degree phase shift.
"""
...
def main():
    try:
        fpath_wav_out = 'Lab1-1.wav'
        wavgen(2, 2000, 16000, 1, 24576, 45, 0, fpath_wav_out)
    except:
