...
def process_wav(fpath_wav_in, fpath_wav_out):
    ...
    # Add a delay to the samples
    delay = 0.1
    delay_samples = int(sample_rate * delay)
    samples = np.concatenate((np.zeros(delay_samples), samples))
...
def main():
    ...
    fpath_wav_out = 'Lab 7 - Acoustic Analysis/source/wav/output/Part2SampleDelay.wav'
